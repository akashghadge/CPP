...
void rotate(int start, int end)
{
    ...
    LINK prevnode = temp_traverse->prev;
    LINK current = temp_traverse;
    LINK temp;
    ...
    cout << "VALUE OF CURRENT NO :" << current->data << endl;
    prevnode->next = current->prev;
    current->next = temp_traverse;
    temp_traverse->next = current->prev;
    
    // prevnode->next = current;
    // current->prev->prev = temp_traverse;
