...
a contains two extra characters ? and *
? means that place can have any one character
* means that place can have any one or more character sequences either same or different
