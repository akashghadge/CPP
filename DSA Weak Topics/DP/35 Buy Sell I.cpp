...
/*
In this example
we have stock in array and only do one transaction
this is very simple approach
here we can just track min and then sell that min

note: same approach is used in pep coding so new dual approach
*/
