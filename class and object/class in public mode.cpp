...
int main()
{
    ...
    d1.setData_public(10); //CLASS INHERITES THE PUBLIC METHODS AS PUBLIC .
    d1.getData_public();   //CLASS INHERITES THE PUBLIC METHODS AS PUBLIC .
    // b1.setData_private(10);            THE CLASS INHERITES THE PRIVATE METHODS AS PRIVATE ONES .
    // b1.getData_private();
    // b1.setData_protected(12);         THE CLASS INHERITES THE PROTECTED METHODS AS PROTECTED ONES .
    // b1.getData_protected();
    d1.set_and_get_protected(2); //THE CLASS METHODS CAN ACCESS THE PROTECTED MEMBERS
    d1.set_and_get_private(3);   //THE CLASS INHERITES THE PUBLIC METHODS AS PRIVATE BUT
